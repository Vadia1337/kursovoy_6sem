...
@section('main_content')
                        ...
                        <div class="page-header">
							<div class="page-leftheader">
								<ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a class="name-label-set" href="/kredit">Кредит</a></li>
								</ol>
							</div>						
						</div>
                        ...
                        <div class="row ">
										...
										<div id="wizard3">
											...
											<div class="plav-stavka-ins">
												...
												<select class="form-control custom-select select input-vklad-select">
													...
													@else
													<option value="0" selected>Выберете срок кредита</option>
													@endif
							...
							<div class="col-md-12 chart-js-11" style="display: none;">
								<div class="card">
									<div class="card-header">
										<div class="card-title">Сумма кредита и переплата</div>
									</div>
									<div class="card-body">
